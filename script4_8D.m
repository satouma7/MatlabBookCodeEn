...
a=0.7;b=0.8;c=10;d=1;X=-2:0.01:2;Y1=-(X.^3)/3+X;Y2=(X+a)/b;%Preparing vectors X, Y1, Y2 to plot the nulclines
for T=1:Tmax-1
...
for T=1000:10:Tmax
    ...
    subplot(1,2,2);plot(X, Y1, X, Y2, V(71,51,T), W(71,51,T),'*','Linewidth',2);ylim([-1 1]);%Plot the values of V, W with asterisks
    pause(0.0001);
end